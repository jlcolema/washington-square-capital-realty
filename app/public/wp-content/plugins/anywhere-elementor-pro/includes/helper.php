...
class Helper {
			...
			foreach ( $fields as $field_name => $field ) {
				...
				if ( $field['type'] === 'repeater' ) {
					...
					if($parent != ''){
							...
							$repeater_from_subfield = $this->get_repeater_field($field['sub_fields'], $option_page, $key, $prefix
						.'- ' );
	...
	public function ae_trim_letters( $string, $start, $length, $append, $html_entity_decode = true, $more = array() ){
