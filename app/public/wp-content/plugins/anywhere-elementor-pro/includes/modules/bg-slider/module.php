...
class Module {
	...
	public function ae_before_render( \Elementor\Element_Base $element ) {
		...
		$bg_slider_data = [
			...
			'timer' => $settings['slider_timer_bar']
		];

		$bg_slider_data_json = wp_json_encode( $bg_slider_data);

		//print_pre(wp_json_encode( $bg_slider_data));
		//print_pre(wp_json_encode( $slides));

		/* $element->add_render_attribute(
				'_wrapper',
				[
					'data-aepro-bg-slider' => wp_json_encode($bg_slider_data),
					'data-ae-slider' => $ae_slider,
				]
			); */
		?> 
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {
				...
				jQuery(".elementor-element-<?php echo $element->get_id(); ?>[data-ae_slider=<?php echo $ae_slider; ?>]").children('.aepro-section-bs').children('.aepro-section-bs-inner').vegas({
				...
				if ('<?php echo $settings['custom_overlay_switcher']; ?>' == 'yes') {
					jQuery(".elementor-element-<?php echo $element->get_id(); ?>[data-ae_slider=<?php echo $ae_slider; ?>]").children('.aepro-section-bs').children('.aepro-section-bs-inner').children('.vegas-overlay').css('background-image', '');
				} */
			});
		</script>
		<?php
