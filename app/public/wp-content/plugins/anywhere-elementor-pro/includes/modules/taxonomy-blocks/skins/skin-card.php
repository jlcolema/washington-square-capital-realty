...
class Skin_Card extends Skin_Base {
	...
	public function render_item( $term, $current_term, $layout ) {
		...
		// 		$this->parent->set_render_attribute( 'term-list-item', 'class', ['ae-term-active', 'ae-term-list-item'] );
		// 	}else{
		// 		$this->parent->set_render_attribute( 'term-list-item', 'class', 'ae-term-list-item');
		// 	}
		// }else{
		// 	if(is_archive()){
		// 		if($term->term_id === $current_term){
		...
		if ( \Elementor\Plugin::instance()->editor->is_edit_mode() ) {
			if($term->term_id == $current_term){
				$class = ['ae-term-active', 'ae-term-list-item', 'ae-term-'.$term->term_id];
				if($layout == 'carousel'){
				...
				$class = ['ae-term-list-item', 'ae-term-'.$term->term_id];
				if($layout == 'carousel'){
					$carousel_class = ['ae-swiper-slide', 'swiper-slide'];
					$class = array_merge($class, $carousel_class); 
				}
