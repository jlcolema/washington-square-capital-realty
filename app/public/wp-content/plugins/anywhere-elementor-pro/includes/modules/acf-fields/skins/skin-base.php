...
abstract class Skin_Base extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		//add_action( 'elementor/element/ae-acf/general/after_section_end', [ $this, 'register_fallback_controls' ] );
	}
	...
	public function register_fallback_controls($add_img_controls = true){
		...
		$this->start_controls_section('fallback_content', [
	...
	public function render_fallback_content($settings, $image_size_field=''){
		...
		$type = $this->get_instance_value('fallback_type');
				switch($type){
					case "text" : 	$text = $this->get_instance_value('fallback_text')
									?>
					...
					case "image" : 	if(empty($image_size_field)){
					...
					case "template" : 	$template_type = $this->get_instance_value('content_type');
