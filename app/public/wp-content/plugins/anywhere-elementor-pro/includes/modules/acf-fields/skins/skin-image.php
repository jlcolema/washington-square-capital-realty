...
class Skin_Image extends Skin_URL {
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/ae-acf/image_section_icon_style/after_section_end', [ $this, 'register_fallback_style' ] );
	...
	public function register_fallback(){
		$this->register_fallback_controls(false);
	}
	...
	public function render() {
		...
		$is_fallback = $this->get_instance_value('fallback_image');
		...
		if(empty($image_id) && !empty($fallback_image['id'])){
			...
			// $settings['image_enable_fallback'] = 'yes';
			// $settings['image_fallback_type'] = 'image';
			// $this->render_fallback_content($settings, 'image_image_size_size');
		}
