 ...
 * @see WP_Widget
 */
class WP_Widget_Media_Gallery2 extends WP_Widget_Media
{
    ...
    {
        parent::__construct('media_gallery', esc_html__('Gallery','consbie'), array(
            'description' => esc_html__('Displays an image gallery.','consbie'),
            'mime_type' => 'image',
        ));

        $this->l10n = array_merge($this->l10n, array(
            'no_media_selected' => esc_html__('No images selected','consbie'),
            'add_media' => esc_html__('Add Images', 'consbie'),
            'replace_media' => '',
            'edit_media' => esc_html__('Edit Gallery', 'consbie'),
        ));
    }
    ...
    public function get_instance_schema()
    {
        $schema = array(
            'title' => array(
                ...
                'description' => esc_html__('Title for the widget', 'consbie'),
            ...
            <div class="gallery media-widget-gallery-preview">
                ...
                <dl class="gallery-item">
                    <dt class="gallery-icon">
                        ...
                        <img src="{{ attachment.sizes.thumbnail.url }}" width="{{ attachment.sizes.thumbnail.width }}"
                             height="{{ attachment.sizes.thumbnail.height }}" alt="<?php echo esc_attr__('gla','consbie'); ?>"/>
                        <# } else { #>
                        <img src="{{ attachment.url }}" alt="<?php echo esc_attr__('gla','consbie'); ?>"/>
                        <# } #>
 ...
 * @since 1.0
 */
function jws_register_custom_gallery()
{
    if(function_exists('insert_widgets')){
    	  insert_widgets('WP_Widget_Media_Gallery2');
    }
}

add_action('widgets_init', 'jws_register_custom_gallery');