...
if ( ! defined( 'ABSPATH' ) ) {
    ...
    function jws_register_studies() {
		$labels = array(
			'name'                => _x( 'studies', 'Post Type General Name', 'consbie' ),
			'singular_name'       => _x( 'studies', 'Post Type Singular Name', 'consbie' ),
			'menu_name'           => esc_html__( 'Studies', 'consbie' ),
		...
		$args = array(
			'label'               => esc_html__( 'studies', 'consbie' ),
		    'labels'              => $labels,
		...
		$labels = array(
			'name'					=> _x( 'studies Categories', 'Taxonomy plural name', 'consbie' ),
			'singular_name'			=> _x( 'studies Category', 'Taxonomy singular name', 'consbie' ),
			'search_items'			=> esc_html__( 'Search Categories', 'consbie' ),
			'popular_items'			=> esc_html__( 'Popular studies Categories', 'consbie' ),
			'all_items'				=> esc_html__( 'All studies Categories', 'consbie' ),
